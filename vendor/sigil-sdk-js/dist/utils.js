...
export function encodedSizeBytes(value) {
    return textEncoder.encode(JSON.stringify(value)).byteLength;
}
export function defaultOperationNameForMode(mode) {
...
export function validateToolExecution(toolExecution) {
...
export function validateEmbeddingStart(start) {
...
export function cloneGeneration(generation) {
    return {
        ...generation,
...
export function cloneGenerationResult(result) {
    return {
        ...result,
...
export function cloneGenerationStart(start) {
    return {
        ...start,
...
export function cloneEmbeddingStart(start) {
    return {
        ...start,
        model: cloneModelRef(start.model),
        tags: start.tags ? { ...start.tags } : undefined,
...
export function cloneEmbeddingResult(result) {
    return {
        ...result,
        inputTexts: result.inputTexts ? [...result.inputTexts] : undefined,
    };
}
export function cloneToolExecution(toolExecution) {
    return {
        ...toolExecution,
...
export function cloneToolExecutionStart(start) {
    return {
        ...start,
        startedAt: start.startedAt ? new Date(start.startedAt) : undefined,
    };
}
export function cloneToolExecutionResult(result) {
    return {
        ...result,
        completedAt: result.completedAt ? new Date(result.completedAt) : undefined,
    };
}
export function cloneModelRef(model) {
    return { ...model };
}
...
export function cloneToolDefinition(tool) {
    return { ...tool };
}
export function cloneArtifact(artifact) {
    return { ...artifact };
}
