...
export type { CallOptions, ConversationResolution, GenerateTextHooks, SigilVercelAiSdkOptions, StepFinishEvent, StepOutputMapping, StepStartEvent, StreamChunkEvent, StreamErrorEvent, StreamTextHooks, ToolCallFinishEvent, ToolCallStartEvent, } from './types.js';
export declare function createSigilVercelAiSdk(client: SigilClient, options?: SigilVercelAiSdkOptions): SigilVercelAiSdkInstrumentation;
