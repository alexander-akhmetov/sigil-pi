...
export declare class SigilLangChainHandler extends SigilFrameworkHandler {
    name: string;
...
export declare function createSigilLangChainHandler(client: SigilClient, options?: FrameworkHandlerOptions): SigilLangChainHandler;
export declare function withSigilLangChainCallbacks<T extends CallbackConfig>(config: T | undefined, client: SigilClient, options?: FrameworkHandlerOptions): T & {
    callbacks: unknown[];
};
