 ...
 */
export function resolveContentCaptureMode(override, fallback) {
    if (override !== 'default') {
        return override;
    }
    return fallback;
 ...
 */
export function resolveClientContentCaptureMode(mode) {
    if (mode === 'default') {
 ...
 */
export function callContentCaptureResolver(resolver, metadata) {
...
export function stampContentCaptureMetadata(generation, mode) {
 ...
 */
export function stripContent(generation, errorCategory) {
...
function stripMessageContent(message) {
 ...
 * `includeContent`.
 */
export function shouldIncludeToolContent(toolMode, clientDefault, resolverMode, legacyInclude) {
...
//# sourceMappingURL=content_capture.js.map